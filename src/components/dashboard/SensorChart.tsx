...
export default function SensorChart({ data, label, color, timeRange = 24, threshold, isBinary = false, timeOffset = 0 }: SensorChartProps) {
  ...
  }), [sortedData, label, isBinary, color, timestampMap, referenceTime]);
  ...
  }), [referenceTime, displayMin, timeRange, timeOffset, isBinary, yMinValue, yMaxValue, yStepSize, color, threshold, label]);
